      ...
      <div className="container relative z-10">
        ...
        <div className="text-center mt-8">
          <motion.button
            ...
            className="bg-gradient-to-r from-accent to-primary text-white hover:from-accent/90 hover:to-primary/90 rounded-xl px-8 py-3 text-sm font-semibold transition-all duration-300 flex items-center justify-center gap-2 shadow-sm hover:shadow-md hover:scale-105 min-h-[44px] mx-auto"
          >
