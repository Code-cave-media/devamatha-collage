        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <motion.div
              ...
              className="mb-8 p-4 rounded-full bg-white/10 backdrop-blur-md border border-white/20"
            >
              <svg 
            ...
            >
              <motion.h1 
                ...
                className="text-4xl md:text-5xl font-bold font-display tracking-wide text-center"
              >
                DEVA MATHA
              </motion.h1>
            </motion.div>
