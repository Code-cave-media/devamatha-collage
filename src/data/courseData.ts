...
export const courses: Course[] = [
  ...
  },
  {
    ...
    description: "B.Com in Business Analytics is a FYUGP undergraduate programme that focuses on analysing business data to support decision-making and strategic planning. The course combines commerce, statistics, and data analysis techniques to equip students with skills in interpreting data and deriving meaningful business insights.",
  ...
  },
  {
    ...
    description: "Bachelor of Computer Applications (BCA) is a FYUGP undergraduate programme that focuses on computer science, software development, and information technology. The course equips students with the knowledge and skills required to design, develop, and manage software applications and IT systems.",
  ...
  },
  {
    id: "bcom-finance",
    name: "B.Com Finance",
    description: "B.Com in Finance is a FYUGP undergraduate programme that focuses on financial management, investment analysis, banking, and accounting. The course provides students with a strong foundation in financial principles and equips them with the skills required to manage financial resources effectively in business organizations.",
  ...
  },
  {
    ...
    description: "B.Com Co-Operation is a FYUGP undergraduate programme that focuses on the principles and practices of co-operative organizations, banking, and rural development. The course combines commerce education with co-operative management to prepare students for careers in co-operative institutions and financial sectors.",
  ...
  },
  {
    id: "ba-english",
    name: "BA English",
    description: "BA English is a FYUGP undergraduate programme that focuses on the study of English literature, language, and communication. The course develops critical thinking, analytical skills, and effective communication abilities through the study of literary texts, linguistics, and cultural contexts.",
