        ...
        <div className="relative z-10 container max-w-7xl mx-auto px-4 text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-foreground/20 border border-primary-foreground/30">
              ...
              <span className="text-sm font-medium">Home &gt; Students Corner</span>
            </div>
          </motion.div>
        ...
        <div className="container max-w-7xl mx-auto px-4 space-y-12">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              <a href="https://kannuradm.kreap.co.in/applicant/?#/login?client=KANNUR" target="_blank" rel="noopener noreferrer" className="group bg-card p-6 rounded-xl border border-border hover:border-accent transition-all hover:scale-105">
                <div className="flex items-center gap-2 text-accent mb-2">
                  <GraduationCap className="w-5 h-5" />
                  <span className="font-semibold">Course Selection</span>
                </div>
                <p className="text-sm text-muted-foreground">Apply for courses</p>
              </a>
              <a href="https://kannurops.kreap.co.in/studentLogin/?#/kannur/studentLogin" target="_blank" rel="noopener noreferrer" className="group bg-card p-6 rounded-xl border border-border hover:border-accent transition-all hover:scale-105">
                <div className="flex items-center gap-2 text-accent mb-2">
              ...
              <a href="https://kannurops.kreap.co.in/?#/kannur" target="_blank" rel="noopener noreferrer" className="group bg-card p-6 rounded-xl border border-border hover:border-accent transition-all hover:scale-105">
                <div className="flex items-center gap-2 text-accent mb-2">
          ...
          >
            ...
            <div className="bg-white dark:bg-card p-6 rounded-xl shadow-md">
              <h3 className="font-semibold text-lg text-foreground mb-4 flex items-center gap-2">
                ...
                Alumni Online Registration - Facilitate online registration form
              </h3>
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li>• Current Employment Status (Employed / Self-employed / Higher Studies / Unemployed)</li>
                    <li>• Organization / Company Name</li>
                    <li>• Job Title / Designation</li>
                    <li>• Work Location (City, State, Country)</li>
                  </ul>
                </div>
              </div>
            </div>
