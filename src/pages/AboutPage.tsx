        ...
        <div className="relative z-10 container max-w-7xl mx-auto px-4 text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-foreground/20 border border-primary-foreground/30">
              ...
              <span className="text-sm font-medium">Home &gt; About</span>
            </div>
          </motion.div>
          ...
          >
            ABOUT DEVAMATHA ARTS AND SCIENCE COLLEGE
          </motion.h1>
        ...
        <div className="container max-w-7xl mx-auto px-2 sm:px-3 md:px-4">
          <div className="w-full">
            ...
            >
              ...
              <div className="prose prose-lg max-w-none">
                <h4 className="text-xl font-bold text-foreground mb-4">Bird's Eye-view of the Past and Present</h4>
                <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Rev. Fr. Sebastian Palakuzhy assumed the mantle of the Manager at Deva Matha in May, 2018. Due to his singular initiatives, the College received the ISO Certification (ISO 9001-2015 Certified Institution of Higher Learning) in March, 2019. He also began a campus beautification programme. Dr. M J Mathew, a renowned educationalist and administrator, is expected to take charge of the College as the Principal, sometime in early July.
                </p>
