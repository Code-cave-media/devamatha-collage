  ...
  const departments = [
    {
      ...
      icon: BookOpen,
      color: "purple",
      description: "Established in 2005, offering BA in English Literature with Journalism and MA in English Language and Literature",
      fullDescription: [
    ...
    },
    {
      ...
      icon: Languages,
      color: "accent",
      description: "Integral part of the institution since inception, promoting language, literature, and cultural studies",
      fullDescription: [
    ...
    },
    {
      ...
      icon: Languages,
      color: "orange",
      description: "Promoting the study of Hindi language and literature, contributing to linguistic and cultural diversity",
      fullDescription: [
    ...
    },
    {
      ...
      icon: Briefcase,
      color: "blue",
      description: "Established in 2010, offering BBA and BBA in Hospital Administration programmes",
      fullDescription: [
    ...
    },
    {
      ...
      icon: Monitor,
      color: "green",
      description: "Established in 2012, offering BCA and B.Sc in AI & Data Science programmes",
      fullDescription: [
    ...
    },
    {
      ...
      fullDescription: [
        ...
        "With its focus on academic excellence, innovation, and holistic development, the PG Department of Commerce continues to prepare students to meet the evolving challenges of the business world with confidence and competence."
      ],
      programmes: [
        "B. Com. Co-Operation",
        "B. Com Finance",
    ...
    },
    {
      ...
      icon: Trophy,
      color: "primary",
      description: "Committed to promoting physical fitness, sportsmanship, and overall well-being among students",
      fullDescription: [
    ...
    },
    {
      ...
      icon: Users,
      color: "gray",
      description: "Administrative and Support Staff ensuring smooth functioning of institutional services",
      fullDescription: [
        ...
        <div className="relative z-10 container max-w-7xl mx-auto px-4 text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-foreground/20 border border-primary-foreground/30">
              <span className="text-sm font-medium">Home &gt; Departments</span>
            </div>
          </motion.div>
            ...
            {departments.map((dept, index) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-base text-muted-foreground mb-6 line-clamp-3">{dept.description}</p>
                  <button
                    onClick={() => navigate(`/departments/${dept.id}/overview`)}
