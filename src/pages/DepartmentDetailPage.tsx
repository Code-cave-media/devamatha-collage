          ...
          <div className="text-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-foreground/20 border border-primary-foreground/30">
                <span className="text-sm font-medium">Home &gt; Departments &gt; {department.name}</span>
              </div>
            </motion.div>
      ...
      <section className="bg-background border-b border-border sticky top-0 z-40">
        <div className="container max-w-7xl mx-auto px-4">
          <div className="flex gap-1 overflow-x-auto">
            <Link
              to={`/departments/${departmentId}/overview`}
            ...
            <Link
              to={`/departments/${departmentId}/faculty-photo`}
              className={`px-6 py-3 font-semibold transition-colors border-b-2 ${
        ...
        <div className="container max-w-7xl mx-auto px-4">
          ...
          {section === "faculty-photo" && (
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              className={`bg-gradient-to-br ${colors.bg} p-8 rounded-3xl border ${colors.border}`}
            >
